...
@Controller
public class CancelManagementController {
    ...
    public String orderControlPage(@RequestParam(value = "page", defaultValue = "1") int page,
        ...
        return "sales/cancelControl";
    }

    @PostMapping("/approveCancelOrders.do")
    public String approveCancelOrders(@RequestParam String selectedOrderIds, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/sales/cancelControl.page";
    }

    @PostMapping("/rejectCancelOrders.do")
    public String rejectCancelOrders(@RequestParam String selectedOrderIds, RedirectAttributes redirectAttributes) {
        List<String> orderIdList = Arrays.asList(selectedOrderIds.split(","));
